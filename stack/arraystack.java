...
public class arraystack {
    ...
    public void push(int x){
        // this condition is applicable only.. when the stack is overflow means stack capacity..
        if(isFull()){
            System.out.print("Stack OverFlow - Cannot Push");
            return;
        }
        arr[++ top] = x; //is line me ye horaha ha kiya  top ki value update hoti ha tu x value update hoti ha...
