public class binarysearch {
    ...
    public static int binarySearchArray(int[] arr, int target) {
        ...
        while (start <= end) {
            ...
            // int mid = (start - end)/ 2; this fomula create the overflow ... overflow
            // mean's the array have min size..

            // this foumale is use for finding the value in real world case... b/s they help
