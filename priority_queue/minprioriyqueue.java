...
public class minprioriyqueue {
    ...
    private void heapifyDown() {
        ...
        while (hasLeftChild(index)) {
            ...
            if (heap[index] <= heap[smallestChildIndex]) {
                ...
                swapp(index, smallestChildIndex);
            }
    ...
    public static void main(String[] args) {
        minprioriyqueue minpq = new minprioriyqueue(5);
        minpq.insert(10);
        minpq.insert(30);
        minpq.insert(5);
        minpq.insert(40);
        ...
        System.out.println("Remove the value:"+ minpq.removeMin());
        System.out.println("After Remove the Min  value: ");
        minpq.showQueue();
